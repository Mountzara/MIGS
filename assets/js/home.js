                ...
                body: `
                    <div class="pillars-grid">
                      ...
                      <article class="pillar-card frame-card">
                        ...
                        <p class="pillar-content"><strong>Components.</strong> NSAIDs first-line for primary dysmenorrhea (NNT&thinsp;~2&ndash;3). Neuromodulators (amitriptyline, nortriptyline, gabapentin, pregabalin, duloxetine) for centrally sensitized pain. Vaginal diazepam, cyclobenzaprine, baclofen, tizanidine for hypertonic pelvic floor. H1/H2 antihistamines for mast-cell-driven endometriosis pain. Topical lidocaine, compounded creams, vaginal estrogen for vestibular and atrophic surfaces.</p>
                      ...
                      <article class="pillar-card frame-card">
                        ...
                        <p class="pillar-content"><strong>Components.</strong> Trigger point injection with a local anesthetic, with or without a steroid, levator ani injection, abdominal wall TPI at Carnett-positive points, onabotulinumtoxinA (Botox) to a refractory levator, pudendal nerve block, and supervised vaginal dilator therapy. Procedures are sequenced behind manual and pharmacologic work, not in front of them.</p>
