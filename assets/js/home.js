   ...
   compiles off the critical path and is cached across visits. */
        ...
        const EVIDENCE = {
            'womens-health': {
                ...
                litLead: 'Across randomized controlled trials and a systematic review, structured osteopathic protocols for primary dysmenorrhea consistently reduce both pain intensity and the number of painful days — and the effect builds across menstrual cycles rather than fading. The strongest signal comes from multi-session courses timed to the pre-menstrual and early-menstrual window. What this means for your care: Hands-on osteopathic treatment here is a measurable, repeatable structural layer added to hormonal and anti-inflammatory management — reaching the spinal, sacral, and fascial contributors those medications alone cannot.',
                ...
                whatYouOffer: [
                    ...
                    { name: 'tender-point point (a tender spot linked to a specific organ) treatment', desc: 'Gentle rotary pressure on small lymphatic-reflex points associated with the uterus and ovaries. Reduces sympathetic tone and improves the local lymphatic drainage thought to contribute to congestive symptoms.' },
            ...
            'pelvic-pain': {
                ...
                litLead: 'For chronic pelvic pain and endometriosis-associated pain, randomized trials (Zota 2023, Muñoz-Gómez 2023) and an updated systematic review support hands-on osteopathic treatment as one layer of a multimodal plan — addressing the organ-to-body-wall, fascial, and musculoskeletal contributors that imaging alone can\'t see, alongside pelvic-floor physical therapy and medical management. What this means for your care: manual osteopathic work targets the structural and neurological substrate of persistent pelvic pain — including pain that lingers after excision surgery — complementing, never replacing, the gynecologic and surgical care that remains the foundation.',
                ...
                whatYouOffer: [
                    ...
                    { name: 'tender-point point (a tender spot linked to a specific organ) treatment', desc: 'Small tender lymphatic-reflex points associated with the female reproductive organs. Gentle rotary pressure for 30–60 seconds per point reduces sympathetic tone and improves the local lymphatic drainage that contributes to pelvic congestion.' },
                ...
                body: `
                    ...
                    <div class="soc-grid">
                      ...
                      <div class="soc-block frame-card">
                        ...
                        <p class="soc-anchors">Anchored to ACOG dysmenorrhea guidance. Systematic-review support: Marjoribanks Cochrane 2015 (NSAIDs, CD001751); Sharghi 2019 (PMID 30521155); Earl 2021 Cochrane (nifedipine, PMID 34921554); Ruffini 2016 systematic review of hands-on osteopathic treatment in gynecology and obstetrics (PMID 27261985).</p>
                      </div>
                    </div>
                `,
            },
