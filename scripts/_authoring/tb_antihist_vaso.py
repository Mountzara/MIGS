...
"35797481": {
    "bottom": "The <strong>North American Menopause Society's 2022 position statement</strong> — the leading US guidance on hormone therapy. It confirms hormone therapy is the <strong>most effective</strong> treatment for menopausal hot flushes and night sweats (vasomotor symptoms), with a favorable benefit-versus-risk balance for most healthy women under 60 or within 10 years of menopause. So if hot flushes are disrupting your life, hormone therapy is the proven first-line option for most people — and it's the benchmark any non-hormonal idea, antihistamines included, has to be measured against; antihistamines have not been established for this.",
    ...
    "applicability": "For most women this is proven first-line relief for hot flushes, with the details — your personal risk, and how soon after menopause you start — worth discussing. When hormones aren't suitable or wanted, the evidence-based non-hormonal options are the ones to turn to; antihistamines aren't among them.",
...
"36734148": {
    "bottom": "A <strong>phase-3 randomized controlled trial (SKYLIGHT 2)</strong> of fezolinetant — a non-hormonal drug that blocks the neurokinin-3 (NK3) receptor — for moderate-to-severe menopausal hot flushes. It's high-quality proof that targeting the <em>right</em> brain pathway relieves hot flushes without hormones. The practical upshot: there's now a proven non-hormonal pill for hot flushes, but it's fezolinetant (an NK3 blocker), not an antihistamine — and its strong trial evidence is exactly the kind the antihistamine idea doesn't have.",
    ...
    "applicability": "A genuine non-hormonal option now exists — fezolinetant — for hot flushes when hormones aren't right for you, distinct from the unproven antihistamine route. It's the option to reach for when a non-hormonal treatment is needed, and it sets the evidence bar antihistamines have not met.",
...
"36924778": {
    "bottom": "A <strong>commentary in The Lancet</strong> accompanying the fezolinetant trials — expert context on what NK3-blocker therapy means for menopause care. It signals that the field sees non-hormonal NK3 blockade as a meaningful advance and helps place fezolinetant among the options. It's editorial perspective rather than new data.",
    ...
    "applicability": "It's supportive context that non-hormonal NK3 therapy is a real advance, and helps with positioning it. It doesn't change the evidence on antihistamines, which remains nothing of this caliber.",
...
"39813600": {
    "bottom": "A <strong>review of kisspeptin and neurokinin B (NKB)</strong> — brain signaling molecules of the KNDy neurons that control reproductive hormones and, importantly, generate hot flushes. It explains <em>why</em> blocking neurokinin B (the NK3 pathway) relieves hot flushes: it's the science behind both why hot flushes happen and why the new non-hormonal drug works. The validated hot-flush pathway here is NKB — not histamine.",
    ...
    "applicability": "It explains the biology behind hot flushes and the new non-hormonal pill, and grounds why NK3 therapy works. It also underscores that the validated hot-flush pathway is NKB-based, not histamine-based.",
