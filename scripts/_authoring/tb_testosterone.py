...
"39283522": {
    "bottom": "A <strong>retrospective cohort from a UK menopause clinic</strong> (510 women on HRT with persistent low libido, mood, and cognitive symptoms) reporting outcomes after adding testosterone cream. It's the kind of real-world study that drives interest in testosterone for mood and cognitive symptoms — and the kind the consensus considers <em>insufficient</em> on its own, because it's observational, uncontrolled, and prone to expectation effects. <strong>For patients:</strong> real-world clinics report mood/cognitive improvement, but without a placebo comparison this can't separate the drug from expectation and natural variation. <strong>For clinicians:</strong> hypothesis-generating, not practice-changing for non-sexual indications.",
