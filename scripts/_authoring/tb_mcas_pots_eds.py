...
"31267471": {
    "bottom": "A <strong>measured review of the proposed triad</strong>. Patients increasingly ask about a unified hEDS + POTS + MCAS 'triad' (hypermobility + a racing-heart-on-standing syndrome + a mast-cell/allergy syndrome). This review finds the three conditions are real and do co-occur, but the evidence that they form one validated syndrome is weak. <strong>For patients:</strong> your symptoms are real and the overlap is recognized — but calling it a single proven disease overstates the science. <strong>For clinicians:</strong> a caution against reifying a popular but unvalidated construct; evaluate and treat each component on its own evidence.",
...
"30729750": {
    "bottom": "A <strong>prevalence study</strong> measuring how common generalized joint hypermobility is among women with chronic myofascial pelvic pain. It supplies one real, measurable pairwise link behind the idea: hypermobility and pelvic pain do travel together more than expected. <strong>For patients:</strong> if you're hypermobile and have pelvic-floor pain, you're not imagining the connection. <strong>For clinicians:</strong> a reason to screen for hypermobility in myofascial pelvic pain — though association isn't causation.",
