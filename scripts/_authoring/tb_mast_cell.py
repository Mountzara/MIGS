...
"40948761": {
    "bottom": "This is a <strong>review article</strong> — it gathers and interprets existing laboratory and animal research rather than testing a treatment in people. Its case is that endometriosis pain isn't only from the lesions themselves but from <em>neuroinflammation</em>: irritated nerves and immune cells (mast cells among them) interacting in and around the lesions, with changes that reach the spinal cord and brain. It highlights two possible drug targets — the JAK-STAT inflammatory pathway and mast-cell activation. This helps explain why pain can persist even after lesions are removed and can be out of proportion to what's seen at surgery. But because it synthesizes mechanism rather than testing a treatment, it points to promising targets, not a proven therapy yet.",
    ...
    "applicability": "This supports the reality that endometriosis pain behaves as a whole-nervous-system condition, which is why a combination of approaches — not surgery alone — is often needed, and it helps make sense of pain that continues after surgery. What it does <em>not</em> do is show that any specific anti-mast-cell or JAK-targeting medication works for endometriosis, so it isn't a basis for using those drugs for this purpose outside a trial.",
...
"40600649": {
    ...
    "applicability": "This is encouraging biology and explains why histamine and mast cells are being studied in endometriosis pain, and it makes a strong case for human trials. It is <em>not</em>, however, evidence that antihistamines or mast-cell stabilizers actually relieve endometriosis pain in people — so it shouldn't be taken as a reason to start those medications for endometriosis outside a trial.",
