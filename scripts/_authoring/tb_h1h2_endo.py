...
"40600649": {
    "bottom": "The <strong>core mechanistic paper</strong> behind this claim. In mice and cells, mast cells drove endometriosis pain by releasing <strong>histamine</strong>, which sensitized sensory nerves through the <strong>HRH1 receptor — the very target that H1 antihistamines block</strong> — and the TRPV1 pain channel; removing mast cells reduced pain. This is the biological reason there's interest in antihistamines for endometriosis pain, and it's a clean rationale for <em>testing</em> H1 antihistamines. But it's a laboratory and animal study, not a treatment trial in people, so it isn't yet a reason to use them.",
    ...
    "applicability": "It explains the rationale for trying antihistamines in endometriosis pain, but it is not evidence that they relieve pain in people — so it's not a reason to self-treat expecting relief, or to prescribe them for this outside a trial.",
...
"40948761": {
    "bottom": "A <strong>review</strong> of endometriosis-pain neurobiology arguing the pain is driven by neuroinflammation involving mast cells and nerve sensitization — the broader context for why blocking histamine with antihistamines is a plausible idea. It's helpful background on why endometriosis pain persists and why immune and histamine pathways are being studied; it's mechanistic framing, not trial evidence for antihistamines.",
    ...
    "applicability": "It supports a whole-system view of endometriosis pain and is useful for understanding and explaining it. It isn't evidence for any specific antihistamine, and isn't prescribing guidance.",
...
"33020832": {
    "bottom": "A <strong>systematic review</strong> showing that endometriosis frequently <strong>recurs after surgery</strong>, and that the evidence for post-operative hormonal therapy to prevent recurrence is limited and inconsistent. In other words, surgery often isn't a cure and pain can return — which is exactly why people look for added options like antihistamines. It's the unmet-need context behind the question, and a reminder that even established hormonal add-ons have weak evidence for preventing recurrence.",
    ...
    "applicability": "It sets realistic expectations that surgery may not be curative and that add-on therapies have limits — useful context for individualized after-surgery management, for honest counseling, and for the interest in better-evidenced add-ons (which antihistamines are not yet).",
...
"33095458": {
    "bottom": "The <strong>Cochrane review of laparoscopic surgery for endometriosis</strong> — the evidence underpinning surgery as a standard treatment for endometriosis pain and difficulty conceiving. It defines what the established treatment <em>is</em>, the baseline against which any new add-on like antihistamines would be compared. Surgery is an evidence-based mainstay; antihistamines are not a substitute for it.",
    ...
    "applicability": "Surgery is the proven mainstay, and antihistamines wouldn't replace it — it's the standard against which any add-on would need to show it adds value.",
...
"36948440": {
    "bottom": "A <strong>review of how endometriosis and adenomyosis affect pregnancy and fertility</strong> — context establishing the reproductive stakes of the disease. It's helpful background on the fertility and pregnancy implications, and it's why effective, fertility-compatible treatments matter — relevant whenever a new therapy's reproductive safety is being weighed.",
    ...
    "applicability": "It helps in understanding the fertility and pregnancy implications when weighing treatments — reproductive considerations shape add-on choices, and any unproven add-on like an antihistamine would also need to be weighed for pregnancy safety.",
